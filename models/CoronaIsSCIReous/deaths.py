...
import numpy as np
import pandas as pd
from data.downloadHelper.downloadtools import timestamp

def collectRawdata():
    jhucsse_USconfirmedcasesUrl = "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_US.csv"
...
if __name__ == "__main__":
    ...
    paData = paData.rename(columns={'variable':'date','value':'deaths'})
