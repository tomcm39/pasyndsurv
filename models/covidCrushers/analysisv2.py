...
if __name__ == '__main__':
    ...
    singleCounty = allData[(allData.fips == 42039) & (allData.trainingweek == mostrecentweek)].set_index('modelweek')
    ...
    # notice the import state abov
    print(singleCounty)
    numnewpos = singleCounty['dohweb__numnewpos']
    for x in range(2611, 2629):
        numnewpos[x] = int(numnewpos[x])
    
    singleCounty['dohweb__numnewpos'] = numnewpos

    data = singleCounty['dohweb__numnewpos']
    data = data[7:]
